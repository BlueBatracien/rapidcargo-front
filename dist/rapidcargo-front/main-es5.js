...
var HistoryComponent = /** @class */ (function () {
    function HistoryComponent(httpClient, _location) {
        this.httpClient = httpClient;
        this._location = _location;
        this.reponse = null;
        this.movements = null;
    }
    HistoryComponent.prototype.getMovements = function () {
        var _this = this;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/movement/last50').subscribe(function (res) {
            _this.movements = res;
            console.log(res);
        });
    };
    HistoryComponent.prototype.toDate = function (date) {
...
var InputComponent = /** @class */ (function () {
    function InputComponent(httpClient, _location, modalService) {
        var _this = this;
        this.httpClient = httpClient;
        this._location = _location;
        ...
        this.searchUser = function (text$) {
            return text$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (term) { return term.length < 0 ? []
                : _this.usersForSearch.filter(function (user) { return (user.toLowerCase().indexOf(term.toLowerCase()) > -1); }).slice(0, 10); }));
        };
    }
    InputComponent.prototype.goBack = function () {
        this._location.back();
    };
    InputComponent.prototype.cancel = function () {
        this.movement = lodash__WEBPACK_IMPORTED_MODULE_7__["cloneDeep"](this.emptyMovement);
    };
    InputComponent.prototype.setTimeOutSuccess = function () {
        var _this = this;
        setTimeout(function () {
    ...
    InputComponent.prototype.setTimeOutError = function () {
        var _this = this;
        setTimeout(function () {
    ...
    InputComponent.prototype.getEmptyMovement = function () {
        var _this = this;
        this.loading = true;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/movement/empty', { params: { type: 'input' } }).subscribe(function (res) {
            _this.movement = res;
            _this.emptyMovement = res;
            _this.loading = false;
            console.log(_this.movement);
        });
    };
    InputComponent.prototype.getWarehouses = function () {
        var _this = this;
        this.warehouses = null;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/warehouse').subscribe(function (res) {
            _this.warehouses = res;
        });
    };
    InputComponent.prototype.getCustoms = function () {
        var _this = this;
        this.customs = null;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/customs').subscribe(function (res) {
            _this.customs = res;
        });
    };
    InputComponent.prototype.getReferenceType = function () {
        var _this = this;
        this.referenceTypes = null;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/referencetype').subscribe(function (res) {
            _this.referenceTypes = res;
        });
    };
    InputComponent.prototype.getUser = function () {
        var _this = this;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/user').subscribe(function (res) {
            _this.users = res;
            _this.users.forEach(function (user) {
                _this.usersForSearch.push(user.firstName + ' ' + user.lastName);
            });
        });
    };
    InputComponent.prototype.createWarehouse = function (warehouseModal) {
        var _this = this;
        this.modalService.open(warehouseModal, { centered: true }).result.then(function () {
            _this.httpClient.post(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/warehouse/create', _this.newWarehouse).subscribe(function (response) {
                _this.alertMessage = response.msg;
                _this.alertSuccess = true;
                _this.getWarehouses();
                _this.setTimeOutSuccess();
            }, function (error) {
                _this.alertMessage = error.error.msg;
                _this.alertError = true;
                _this.setTimeOutError();
            });
            _this.newWarehouse.code = null;
            _this.newWarehouse.name = null;
        });
    };
    InputComponent.prototype.createReference = function (referenceModal) {
        var _this = this;
        this.modalService.open(referenceModal, { centered: true }).result.then(function () {
            _this.httpClient.post(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/referencetype/create', _this.newReferenceType).subscribe(function (response) {
                _this.alertMessage = response.msg;
                _this.alertSuccess = true;
                _this.getReferenceType();
                _this.setTimeOutSuccess();
            }, function (error) {
                _this.alertMessage = error.error.msg;
                _this.alertError = true;
            ...
            _this.newReferenceType = null;
        });
    };
    InputComponent.prototype.isCustomsStatusNotExisting = function () {
        var _this = this;
        var res = false;
        this.customs.forEach(function (el) {
            if (_this.newCustoms != null) {
                if (el.status == _this.newCustoms.toUpperCase()) {
                    res = true;
                }
            }
        });
    ...
    InputComponent.prototype.createCustoms = function (customsModal) {
        var _this = this;
        this.modalService.open(customsModal, { centered: true }).result.then(function () {
            _this.httpClient.post(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/customs/create', _this.newCustoms).subscribe(function (response) {
                _this.alertMessage = response.msg;
                _this.alertSuccess = true;
                _this.getCustoms();
                _this.setTimeOutSuccess();
            ...
            _this.newCustoms = null;
        });
    };
    InputComponent.prototype.createInputMovement = function (submitModal) {
        var _this = this;
        this.modalService.open(submitModal, { centered: true }).result.then(function () {
            _this.loadingWhileResponse = true;
            if (_this.realizedDate.month.length !== 2) {
                _this.realizedDate.month = '0' + _this.realizedDate.month;
            }
            if (_this.realizedDate.day.length === 1) {
                _this.realizedDate.day = '0' + _this.realizedDate.day;
            }
            var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
            params = params.append('user', _this.selectedUser);
            params = params.append('date', _this.realizedDate.year + '-' + _this.realizedDate.month + '-' + _this.realizedDate.day);
            params = params.append('email', _this.recepientAddress);
            _this.httpClient.post(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/movement/createInput', _this.movement, { params: params }).subscribe(function (response) {
                _this.alertMessage = response.msg;
                _this.getEmptyMovement();
                _this.alertSuccess = true;
                _this.setTimeOutSuccess();
                _this.loadingWhileResponse = false;
            }, function (error) {
                _this.alertMessage = error.error.msg;
                _this.alertError = true;
                _this.setTimeOutError();
            ...
            _this.realizedDate = null;
            _this.recepientAddress = null;
        });
    };
    InputComponent.prototype.cannotSubmit = function () {
...
var OutputComponent = /** @class */ (function () {
    function OutputComponent(httpClient, _location, modalService) {
        var _this = this;
        this.httpClient = httpClient;
        this._location = _location;
        this.modalService = modalService;
    ...
    OutputComponent.prototype.cancel = function () {
        this.movement = lodash__WEBPACK_IMPORTED_MODULE_7__["cloneDeep"](this.emptyMovement);
    };
    OutputComponent.prototype.setTimeOutSuccess = function () {
        var _this = this;
        setTimeout(function () {
            _this.alertSuccess = false;
            _this.alertMessage = null;
    ...
    OutputComponent.prototype.setTimeOutError = function () {
        var _this = this;
        setTimeout(function () {
            _this.alertError = false;
            _this.alertMessage = null;
    ...
    OutputComponent.prototype.getEmptyMovement = function () {
        var _this = this;
        this.loading = true;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/movement/empty', { params: { type: 'output' } }).subscribe(function (res) {
            _this.movement = res;
            _this.emptyMovement = lodash__WEBPACK_IMPORTED_MODULE_7__["cloneDeep"](res);
            _this.loading = false;
            console.log(_this.movement);
        });
    };
    OutputComponent.prototype.getWarehouses = function () {
        var _this = this;
        this.warehouses = null;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/warehouse').subscribe(function (res) {
            _this.warehouses = res;
    ...
    OutputComponent.prototype.getCustoms = function () {
        var _this = this;
        this.customs = null;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/customs').subscribe(function (res) {
            _this.customs = res;
    ...
    OutputComponent.prototype.getReferenceType = function () {
        var _this = this;
        this.referenceTypes = null;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/referencetype').subscribe(function (res) {
            _this.referenceTypes = res;
    ...
    OutputComponent.prototype.getUser = function () {
        var _this = this;
        this.httpClient.get(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/user').subscribe(function (res) {
            _this.users = res;
            _this.users.forEach(function (user) {
    ...
    OutputComponent.prototype.createWarehouse = function (warehouseModal) {
        var _this = this;
        this.modalService.open(warehouseModal, { centered: true }).result.then(function () {
            _this.httpClient.post(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/warehouse/create', _this.newWarehouse).subscribe(function (response) {
                _this.alertMessage = response.msg;
    ...
    OutputComponent.prototype.createReference = function (referenceModal) {
        var _this = this;
        this.modalService.open(referenceModal, { centered: true }).result.then(function () {
            _this.httpClient.post(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/referencetype/create', _this.newReferenceType).subscribe(function (response) {
                _this.alertMessage = response.msg;
    ...
    OutputComponent.prototype.isCustomsStatusNotExisting = function () {
        var _this = this;
        var res = false;
        this.customs.forEach(function (el) {
            if (_this.newCustoms != null) {
    ...
    OutputComponent.prototype.createCustoms = function (customsModal) {
        var _this = this;
        this.modalService.open(customsModal, { centered: true }).result.then(function () {
            _this.httpClient.post(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/customs/create', _this.newCustoms).subscribe(function (response) {
                _this.alertMessage = response.msg;
    ...
    OutputComponent.prototype.cannotSubmit = function () {
        return (this.movement.merchandiseInfo.totalQuantity < this.movement.merchandiseInfo.quantity)
            || (this.movement.merchandiseInfo.totalWeight < this.movement.merchandiseInfo.weight)
    ...
    OutputComponent.prototype.createOutputMovement = function (submitModal) {
        var _this = this;
        this.modalService.open(submitModal, { centered: true }).result.then(function () {
            _this.loadingWhileResponse = true;
            if (_this.realizedDate.month.length !== 2) {
            ...
            params = params.append('date', _this.realizedDate.year + '-' + _this.realizedDate.month + '-' + _this.realizedDate.day);
            params = params.append('email', _this.recepientAddress);
            _this.httpClient.post(_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/movement/createOutput', _this.movement, { params: params }).subscribe(function (response) {
                _this.alertMessage = response.msg;
                _this.getEmptyMovement();
                _this.alertSuccess = true;
                _this.setTimeOutSuccess();
    ...
    OutputComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModal"] }
    ]; };
